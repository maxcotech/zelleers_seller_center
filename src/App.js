    ...
    <HashRouter>
      ...
      <React.Suspense fallback={loading}>
        <Switch>
          ...
          <Route exact path="/invalid-account" name="Invalid Account" render={props => <InvalidAccount {...props} />} />
          <Route exact path="/forgot-password" name="Forgot password" render={props => <ForgotPassword {...props} />} />
          <Route exact path="/verify-account" name="Verify account" render={props => <VerifyAccount {...props} />} />
