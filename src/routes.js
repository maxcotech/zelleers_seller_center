...
const CreateStore = React.lazy(() =>
  import("./pages/store/create_store/CreateStore")
);
const Logout = React.lazy(() => import("./pages/logout/Logout"));
const StaffTokens = React.lazy(() =>
  import("./pages/store/staff_tokens/StaffTokens")
);
const SelectStore = React.lazy(() =>
  import("./pages/store/select_store/SelectStore")
);
const JoinStore = React.lazy(() =>
  import("./pages/store/join_store/JoinStore")
);
const StoreStaffs = React.lazy(() =>
  import("./pages/store/store_staffs/StoreStaffs")
);
const CreateProduct = React.lazy(() =>
  import("./pages/products/product_upload_form/ProductUploadForm")
);
const ProductTable = React.lazy(() =>
  import("./pages/products/product_table/ProductTable")
);
const EditStore = React.lazy(() =>
  import("./pages/store/edit_store/EditStore")
);
const ShippingGroups = React.lazy(() =>
  import("./pages/shipping/shipping_groups/ShippingGroups")
);
const Payments = React.lazy(() => import("./pages/payment/Payment"));
const Orders = React.lazy(() => import("./pages/orders/Orders"));
const DashboardPage = React.lazy(() => import("./pages/dashboard/Dashboard"));
const StoreWallet = React.lazy(() =>
  import("./pages/store_fund/store_wallet/StoreWallet")
);
const BankAccounts = React.lazy(() =>
  import("./pages/store_fund/bank_account/BankAccounts")
);
